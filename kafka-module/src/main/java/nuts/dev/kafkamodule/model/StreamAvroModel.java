 ...
 */
package nuts.dev.kafkamodule.model;
...
public class StreamAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3522305587040298478L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StreamAvroModel\",\"namespace\":\"nuts.dev.kafkamodule.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static nuts.dev.kafkamodule.model.StreamAvroModel.Builder newBuilder() {
    return new nuts.dev.kafkamodule.model.StreamAvroModel.Builder();
  }
   ...
   * @return A new StreamAvroModel RecordBuilder
   */
  public static nuts.dev.kafkamodule.model.StreamAvroModel.Builder newBuilder(nuts.dev.kafkamodule.model.StreamAvroModel.Builder other) {
    if (other == null) {
      return new nuts.dev.kafkamodule.model.StreamAvroModel.Builder();
    } else {
      return new nuts.dev.kafkamodule.model.StreamAvroModel.Builder(other);
    }
  }
   ...
   * @return A new StreamAvroModel RecordBuilder
   */
  public static nuts.dev.kafkamodule.model.StreamAvroModel.Builder newBuilder(nuts.dev.kafkamodule.model.StreamAvroModel other) {
    if (other == null) {
      return new nuts.dev.kafkamodule.model.StreamAvroModel.Builder();
    } else {
      return new nuts.dev.kafkamodule.model.StreamAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StreamAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nuts.dev.kafkamodule.model.StreamAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nuts.dev.kafkamodule.model.StreamAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder setText(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nuts.dev.kafkamodule.model.StreamAvroModel.Builder clearCreatedAt() {
      createdAt = null;
